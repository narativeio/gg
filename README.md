...
## Installation
    ...
    go get -u github.com/narativeio/gg

Alternatively, you may use gopkg.in to grab a specific major-version:

    go get -u gopkg.in/narativeio/gg.v1

## Documentation

- godoc: https://godoc.org/github.com/narativeio/gg
- pkg.go.dev: https://pkg.go.dev/github.com/narativeio/gg?tab=doc
...
There are [lots of examples](https://github.com/narativeio/gg/tree/master/examples) included. They're mostly for testing the code, but they're good for learning, too.
